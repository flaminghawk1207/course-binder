...
def addChannel(adminName, adminPassword, username, channelName, channelRole, url, shouldFail = False):
    try:
...
def main():
    url = const.BASE_URL
    addChannel(const.ADMIN_USER, const.ADMIN_PASSWORD, "Lakshya", "POPL", "", url, shouldFail=True)
